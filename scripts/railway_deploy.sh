...
echo ""
echo -e "${YELLOW}4. DB Index Verification (Task 10):${NC}"
echo "   python tests/test_production_db_indexes.py --env-file .env.production"
echo ""
echo -e "${YELLOW}5. Refresh Token Cleanup Job (schedule daily):${NC}"
echo "   python scripts/cleanup_refresh_tokens.py --expired-retention-days 7 --revoked-retention-days 30"
echo ""
